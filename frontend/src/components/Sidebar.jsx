...
const navItems = [
  ...
  },
  {
    ...
    labelKey: 'nav.bookDoctor', path: '/doctors'
  },
  {
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    labelKey: 'nav.myAppointments', path: '/my-appointments'
  },
  {
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    labelKey: 'nav.liveQueue', path: '/live-queue'
  },
  {
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    labelKey: 'nav.reminders', path: '/reminders'
  },
  {
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
