...
function TopBar() {
  ...
  return (
    <>
      {/* Sidebar is rendered here so TopBar controls its open state */}
      <Sidebar isOpen={sidebarOpen} onClose={() => setSidebarOpen(false)} />

      <div className="flex items-center justify-between px-4 sm:px-8 py-4 bg-white border-b border-gray-100 sticky top-0 z-10">
        ...
        {/* Mobile logo — visible only on mobile next to hamburger */}
