  ...
  return (
    <div className="flex items-center justify-between px-4 sm:px-6 py-4 bg-white border-b border-gray-100 sticky top-0 z-10">
      ...
      <div className="flex items-center gap-2 sm:gap-4">
        <Link to="/ai-chat" className="flex items-center gap-2 bg-cyan-50 text-cyan-600 px-3 sm:px-4 py-2 rounded-xl text-sm font-semibold hover:bg-cyan-100 transition-colors">
        ...
        <button onClick={handleLogout} className="text-gray-400 hover:text-red-500 transition-colors" title={t('common.logout')}>
