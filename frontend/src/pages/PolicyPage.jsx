  ...
  return (
    <div>
      <p className="font-normal text-gray-600 leading-relaxed mb-6">
        ...
        your information when you use the Niraamo mobile application (the
        "App"). By using Niraamo, you agree to the collection and use of
  ...
  return (
    <div>
      <p className="font-normal text-gray-600 leading-relaxed mb-6">
        ...
        mobile application. By creating an account or using Niraamo, you
      ...
      <Section title="7. No Payments Through the App">
        <p>
          Niraamo is free to download and use for patients. The app does not
