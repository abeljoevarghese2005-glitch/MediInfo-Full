...
function NoAppointments({ navigate }) {
  return (
    <div className="flex-1 flex flex-col items-center justify-center py-16 px-8">
      ...
      <p className="text-gray-700 font-bold mb-1">No active appointments</p>
...
function AppointmentSelector({ appointments, onSelect, navigate }) {
...
function MyAppointments() {
  ...
  const renderContent = () => {
    ...
    if (appointments.length === 0) return <NoAppointments navigate={navigate} />
    return (
      <AppointmentSelector
